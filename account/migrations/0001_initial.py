    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.CharField(blank=True, max_length=20, null=True, verbose_name='County')),
                ('town', models.CharField(blank=True, max_length=20, null=True, verbose_name='Town')),
                ('image', models.ImageField(blank=True, null=True, upload_to=account.models.user_directory_path, verbose_name='Image')),
